//
//  ZoomTapAddressAnnotation.swift
//  skatecreteordie
//
//  Created by JAMES K ARASIM on 5/11/16.
...
class ZoomTapAddressAnnotation: TestHelper {
    ...
    func testZoomTapAddressAnnotation() {
        ...
        let chatButton = app.buttons[chatButtonLabel]
        ...
        if let parkPinToTap=constructPinLabelNameFromParkName("Kelso Skatepark"){
            ...
            chatButton.tap()
            waitFor(webview(), seconds: defaultWait)
